    ...
    <footer className={s.footer}>
      <Container>
        <div className={s.footer__content}>
          <img className={s.footer__logo} src={logo} alt='Логотип YourMeal' />

          <address className={s.footer__address}>
            <div className={s.footer__contact}>
              <h2 className={s.footer__title}>Номер для заказа</h2>

              <a className={s.footer__phone} href='tel:+79308333811'>
            ...
            <div className={s.footer__contact}>
              <h2 className={cn(s.footer__title, s.footer__title_sn)}>Мы в соцсетях</h2>

              <ul className={s.footer__list}>
                <li className={s.footer__item}>
                  <a href='#' className={s.footer__sn} aria-label='группа в вк'>
                    <svg
                      width='36'
                      height='36'
                      viewBox='0 0 36 36'
                ...
                <li className={s.footer__item}>
                  <a href='#' className={s.footer__sn} aria-label='канал в telegram'>
                    <svg
                      width='36'
                      height='36'
                      viewBox='0 0 36 36'
          ...
          <div className={s.footer__development}>
            <p>© YouMeal, 2022</p>
            <p>
